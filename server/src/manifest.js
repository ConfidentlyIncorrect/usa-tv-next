...
const manifest = {
    ...
    version: '3.0.0',
    name: 'USA TV Next',
    description: 'USA live TV with an integrated Electronic Program Guide. Browse 281 channels with Now Playing / Up Next, full day schedules, search, and genre filtering — streams and guide served from a single addon, with multiple stream sources per channel for reliability.',
